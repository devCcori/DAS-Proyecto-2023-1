...
public class Compras_Main extends javax.swing.JFrame {

    /**
     * Creates new form Compras_Main
     */
    public Compras_Main() {
        initComponents();
    ...
    private void btnNewActionPerformed(java.awt.event.ActionEvent e) {//GEN-FIRST:event_btnNewActionPerformed
        New_Compra new_Compra = new New_Compra();
        new_Compra.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Compras_Main.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        //</editor-fold>
