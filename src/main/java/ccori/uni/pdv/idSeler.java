...
public class idSeler extends javax.swing.JFrame {
  ...
  private void initComponents() {
    ...
    try {
      jComboBox1.setModel(
          pdvUtils.getComboBoxModel("Empleados", "ID_Empleado"));
    } catch (SQLException e) {
      JOptionPane.showMessageDialog(null, e.getMessage());
    }

    // crea un evento que se ejecuta cuando se selecciona un elemento del
    // combobox:
    jComboBox1.addActionListener((java.awt.event.ActionEvent evt) -> {
      // obtiene el valor seleccionado del combobox:
      String id = jComboBox1.getSelectedItem().toString();
      String sql =
          "SELECT Nombre FROM Empleados WHERE ID_Empleado = '" + id + "'";
      try {
  ...
  btnLoginActionPerformed(java.awt.event.ActionEvent
    ...
    // obtiene el valor seleccionado del combobox lo devuelve y cierra la
    // ventana:
    String id = jComboBox1.getSelectedItem().toString();
  ...
  public static void main(String args[]) {
    ...
    try {
      ...
      java.util.logging.Logger.getLogger(idSeler.class.getName())
    ...
    java.awt.EventQueue.invokeLater(new Runnable() {
      public void run() { new idSeler().setVisible(true); }
    });
  }
