...
public class pdvUtils {
  ...
  // define una funcion que rellena las opciones de un combobox con la columan
  // de una tabla de una bd sql server:
  public static javax.swing.DefaultComboBoxModel<String>
  getComboBoxModel(String tableName, String columnName) throws SQLException {
    javax.swing.DefaultComboBoxModel<String> model =
        new javax.swing.DefaultComboBoxModel<>();
    try (Connection cn = sqlConnection.getConnection();
         Statement st = cn.createStatement();
         ResultSet rs =
             st.executeQuery("SELECT " + columnName + " FROM " + tableName)) {
      while (rs.next()) {
