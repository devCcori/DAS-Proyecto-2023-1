...
public class Empleados extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        try {
            jTable1.setModel(showTable.getTableModel("Empleados"));
        } catch (SQLException e) {
            JOptionPane.showMessageDialog(this, "Error al cargar los datos de los empleados.", "Error", JOptionPane.ERROR_MESSAGE);
        }
